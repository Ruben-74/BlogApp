...
<body class="antialiased pt-10 pb-16 md:pb-32">
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <header class="flex justify-between items-center space-x-5 text-slate-900">
            ...
            <nav x-data="{ open: false }" x-cloak class="relative">
                ...
                >
                    ...
                    @auth {{-- https://github.com/creativeorange/gravatar pour utiliser le package GRAVATAR --}}
                ...
                >
                    ...
                    {{-- prevent permet d'annuler la redirection par defaut de l'element du formulaire reçu de la variable x-ref=logout ($refs.logout)--}}
        ...
        <main class="mt-10 md:mt-12 lg:mt-16">
            ...
            {{ $slot }} {{-- Slot va prendre tout ce qui se trouve dans dans les balises x-layout au niveau d'index.blade.php et show --}}
